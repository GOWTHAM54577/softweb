...
<body>
    ...
    <h1>
        <div class="first">Tech Boss: Building Tomorrow's</div>
    ...
    <footer>
        ...
        Designed and Developed by Gowtham N 2024
    </footer>
...
<head>
    ...
    <body>
        ...
        <div class="info">
            ...
            <b>Email: </b>TechBoss.Studio@gmail.com<br><br>
            <b>Phone: </b>044-8974
        </div>
        <div class="vl"></div>
    </div>
...
<head>
    ...
    <style>
        ...
        body{
        background-color:rgb(233, 124, 15);
        margin:0;
        }
        .navbar ul{
        list-style-type:none;
...
<body>
    <header>
        ...
        <div class="search"><input type="text" placeholder="Enter to Search">
            <button>Search</button></div>
        <div class="cirpic">
            <img class="small border" src="person1.jpg" width="500px">
            <img class="small border" src="person2.jpg" width="500px" >
            <img class="small border" src="person3.jpg" width="500px">
            <img class="small border" src="person4.jpg" width="500px" >
            <img class="small border" src="person5.jpg" width="500px">
            <img class="small border" src="person6.jpg" width="500px" >
        </div>
        <div class ="text">
...
## OUTPUT:
![alt text](<Screenshot 2024-04-30 120332.png>)
![alt text](<Screenshot 2024-04-30 120358.png>)
![alt text](<Screenshot 2024-04-30 120407.png>)
![alt text](<Screenshot 2024-04-30 121056.png>)
## RESULT:
